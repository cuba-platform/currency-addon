...
public class CurraddonTestContainer extends TestContainer {

    public CurraddonTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/addon/currency/app.properties",
    ...
    public static class Common extends CurraddonTestContainer {

        public static final CurraddonTestContainer.Common INSTANCE = new CurraddonTestContainer.Common();
